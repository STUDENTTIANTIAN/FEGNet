...
class setting_config:
    ...
    datasets = 'isic18'
    if datasets == 'isic17':
        data_path = '/media/wx/b4532d3e-29e1-497d-87a3-095dda5d193d/pyproject/FEGNet/data/dataset_isic17/'
    elif datasets == 'isic18':
        data_path = '/media/wx/b4532d3e-29e1-497d-87a3-095dda5d193d/pyproject/FEGNet/data/dataset_isic18/'
    elif datasets == 'ph2':
        data_path = '/media/wx/b4532d3e-29e1-497d-87a3-095dda5d193d/pyproject/FEGNet/data/PH2/'
    else:
